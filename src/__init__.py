...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--task", help="Specifies the task to be used.", required=False, default="wp02")
    parser.add_argument("-g", "--graphs", help="Specifies the graphs to be used.", required=False, default=file_path)
    parser.add_argument("-a", "--algorithm", help="(wp03) Specifies the clustering algorithm to be used.", required=False, default="vertex_count")
    ...
    parser.add_argument("-d", "--depth", help="(wp04b) Specifies the clustering depth.", required=False, default=0)
